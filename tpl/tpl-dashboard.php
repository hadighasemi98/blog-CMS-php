...
<div class="container-fluid">
  <div class="row">
      ...
      <div class="position-sticky pt-3">
        <ul id="side-Menu" class="nav flex-column">
          ...
          <span class="bi bi-house-door-fill"></span>
            <a class="nav-link active" style=" background-color: #abd1eaad; " aria-current="page" href="dashboard.php">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?= site_url('users.php'); ?>">
   ...
   <br><br>
   <div class="container-fluid" style="width: 79%;margin-left: 21%;">
