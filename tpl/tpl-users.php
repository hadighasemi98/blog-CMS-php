...
<div class="container-fluid">
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul id="side-Menu" class="nav flex-column">
          ...
          <li class="nav-item ">
            <a class="nav-link active" style=" background-color: #abd1eaad; " href="users.php">
   ...
   <br><br>
    ...
    <?= isset($successUserEdit) ? "<div class='alert alert-success' style=' margin-left: 42%; text-align: center; ' role='alert'> $successUserEdit </div>" : "" ?>
    <div class="container"  style="margin-left: 20%;" >
      <div class="row">
          ...
          <div class="modal-body">
            <form id="formData" method="POST" action="" enctype="multipart/form-data">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="fullName" placeholder="Enter Your userName" >
              </div>

               <div class="form-group">
                <label for="name">Email:</label>
                <input type="email" class="form-control" name="emailAddress" placeholder="Enter Your Email " >
              </div>
              ...
              <div class="form-group float-right">
                <button type="submit" class="btn btn-success" name="addSub" id="submit">Submit</button>
        ...
        <div class="modal-content">
          ...
          <form id="EditformData"  method="POST" action="" enctype="multipart/form-data">
             ...
             <div class="form-group">
                ...
                <input type="file" class="form-control" name="upAvatar" id="avatar" >
              </div> 
