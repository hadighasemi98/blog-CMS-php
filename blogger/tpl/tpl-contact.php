...
<html>
<head>
<title>قالب سایت وبلاگی و خبری</title>
...
<body>
	...
	<div class="full">
			<div class="col-md-3 top-nav gallery-sec">
				     <div class="logo">
						<a href="#"><h1>وبلاگ نویس</h1></a>
					</div>
					<div class="top-menu">
					 <span class="menu"> </span>

					<ul class="cl-effect-16">
						<li><a class="active" href="#" data-hover="HOME">صفحه اصلی</a></li> 
						<li><a href="#" data-hover="About">درباره ما</a></li>
						<li><a href="#" data-hover="Grids">گرید ها</a></li>
						<li><a href="#" data-hover="Services">خدمات</a></li>
						<li><a href="#" data-hover="Gallery">گالری</a></li>
						<li><a href="#" data-hover="CONTACT">تماس با ما</a></li>
					</ul>
					<!-- script-for-nav -->
					<script>
	...
	<div class="col-md-9 main">
	 <div class="contact">
	   <h3 class="tittle"> در دست ساخت :) ...<i class="glyphicon glyphicon-map-marker"></i></h3>
		...
		<div class="contact-left">
			...
			<p class="phn-bottom">ایران-تهران
					<span>آدرـــــــــــــــــــــس</span></p>
			<p class="lom">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد</p>
		</div>
		<div class="clearfix"> </div>
		<div class="contact-right1">
			<h3>تماس با ما<span>
هر گونه سوال</span></h3>
			<div class="in-right">
				<form>
					<p class="your-para">نام :</p>
							<input type="text" value="" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='';}">
							<p class="your-para">ایمیل :</p>
							<input type="text" value="" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='';}">
							<p class="your-para">تلفن:</p>
							<input type="text" value="" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='';}">
		...
		<div class="contact-left1">
			<h3><span>وب سایت های اجتماعی</span></h3>
			<h4>لورم ایپسوم متن ساختگی با تولید سادگی <label>نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است</label></h4>
...
آدرس محل سکونت</h4>
		...
		<div class="copy">
		    <p>کلیه حقوق مادی و معنوی برای مجموعه برنامه نویسان محفوظ می باشد<a href="#">برنامه نویسان</a> </p>
		</div>
	 <div class="clearfix"> </div>
	</div>
	<div class="clearfix"> </div>
